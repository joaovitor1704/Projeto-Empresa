...
public:
    ...
    bool operator==(const Data &d2) const;       //Sobrecarga do operador de comparacao eq
    bool operator<(const Data &d2) const;        //Sobrecarga do operador de comparacao lt
    bool operator>(const Data &d2) const;        //Sobrecarga do operator de comparacao gt
